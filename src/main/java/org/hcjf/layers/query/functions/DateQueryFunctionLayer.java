...
public class DateQueryFunctionLayer extends BaseQueryFunctionLayer implements QueryFunctionLayerInterface {
    ...
    public DateQueryFunctionLayer() {
        super(SystemProperties.get(LayerSystemProperties.Query.Function.DATE_FUNCTION_NAME));
    ...
    public Object evaluate(String functionName, Object... parameters) {
        ...
        switch (functionName) {
            ...
            case PLUS_YEARS: result = getZonedDateTimeFromDate(1, parameters).plusYears(((Number)parameters[parameters.length - 1]).longValue()); break;
            case PLUS_MONTHS: result = getZonedDateTimeFromDate(1, parameters).plusMonths(((Number)parameters[parameters.length - 1]).longValue()); break;
            case PLUS_DAYS: result = getZonedDateTimeFromDate(1, parameters).plusDays(((Number)parameters[parameters.length - 1]).longValue()); break;
            case PLUS_HOURS: result = getZonedDateTimeFromDate(1, parameters).plusHours(((Number)parameters[parameters.length - 1]).longValue()); break;
            case PLUS_MINUTES: result = getZonedDateTimeFromDate(1, parameters).plusMinutes(((Number)parameters[parameters.length - 1]).longValue()); break;
            case PLUS_SECONDS: result = getZonedDateTimeFromDate(1, parameters).plusSeconds(((Number)parameters[parameters.length - 1]).longValue()); break;
            case MINUS_YEARS: result = getZonedDateTimeFromDate(1, parameters).minusYears(((Number)parameters[parameters.length - 1]).longValue()); break;
            case MINUS_MONTHS: result = getZonedDateTimeFromDate(1, parameters).minusMonths(((Number)parameters[parameters.length - 1]).longValue()); break;
            case MINUS_DAYS: result = getZonedDateTimeFromDate(1, parameters).minusDays(((Number)parameters[parameters.length - 1]).longValue()); break;
            case MINUS_HOURS: result = getZonedDateTimeFromDate(1, parameters).minusHours(((Number)parameters[parameters.length - 1]).longValue()); break;
            case MINUS_MINUTES: result = getZonedDateTimeFromDate(1, parameters).minusMinutes(((Number)parameters[parameters.length - 1]).longValue()); break;
            case MINUS_SECONDS: result = getZonedDateTimeFromDate(1, parameters).minusSeconds(((Number)parameters[parameters.length - 1]).longValue()); break;
