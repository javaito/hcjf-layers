...
public class MathQueryFunctionLayer extends BaseQueryFunctionLayer implements NumberSetFunction {
    ...
    private static final String EVAL_EXPRESSION = SystemProperties.get(LayerSystemProperties.Query.Function.MATH_EVAL_EXPRESSION_NAME);
    public MathQueryFunctionLayer() {
        super(SystemProperties.get(LayerSystemProperties.Query.Function.MATH_FUNCTION_NAME));
