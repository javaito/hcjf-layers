...
public final class SQLCompiler extends Layer implements QueryCompiler {
    ...
    public Query compileSingleQuery(String resourceName) {
        return compile(String.format(SystemProperties.get(LayerSystemProperties.Query.SINGLE_PATTERN), resourceName));
    }
    ...
    private Query compile(List<String> groups, List<String> richTexts, Integer startGroup, AtomicInteger placesIndex) {
        ...
        String[] unions = groups.get(startGroup).split(SystemProperties.get(LayerSystemProperties.Query.UNION_REGULAR_EXPRESSION));
        String queryDefinition = unions[0].trim();
        Pattern pattern = SystemProperties.getPattern(LayerSystemProperties.Query.SELECT_REGULAR_EXPRESSION);
        Matcher matcher = pattern.matcher(queryDefinition);

        if(matcher.matches()) {
            String environmentBody = matcher.group(SystemProperties.get(LayerSystemProperties.Query.ENVIRONMENT_GROUP_INDEX));
            String selectBody = matcher.group(SystemProperties.get(LayerSystemProperties.Query.SELECT_GROUP_INDEX));
            selectBody = selectBody.replaceFirst(Strings.CASE_INSENSITIVE_REGEX_FLAG+ SystemProperties.get(LayerSystemProperties.Query.ReservedWord.SELECT), Strings.EMPTY_STRING);
            String fromBody = matcher.group(SystemProperties.get(LayerSystemProperties.Query.FROM_GROUP_INDEX));
            fromBody = fromBody.replaceFirst(Strings.CASE_INSENSITIVE_REGEX_FLAG+ SystemProperties.get(LayerSystemProperties.Query.ReservedWord.FROM), Strings.EMPTY_STRING);
            String conditionalBody = matcher.group(SystemProperties.get(LayerSystemProperties.Query.CONDITIONAL_GROUP_INDEX));
            if(conditionalBody != null && conditionalBody.endsWith(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.STATEMENT_END))) {
                conditionalBody = conditionalBody.substring(0, conditionalBody.indexOf(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.STATEMENT_END))-1);
            }

            String resourceValue = matcher.group(SystemProperties.get(LayerSystemProperties.Query.RESOURCE_VALUE_INDEX));
            String dynamicResource = matcher.group(SystemProperties.get(LayerSystemProperties.Query.DYNAMIC_RESOURCE_INDEX));
            String dynamicResourceAlias = matcher.group(SystemProperties.get(LayerSystemProperties.Query.DYNAMIC_RESOURCE_ALIAS_INDEX));
            ...
            if(conditionalBody != null) {
                Pattern conditionalPatter = SystemProperties.getPattern(LayerSystemProperties.Query.CONDITIONAL_REGULAR_EXPRESSION, Pattern.CASE_INSENSITIVE);
                ...
                for (int i = 0; i < conditionalElements.size(); i++) {
                    ...
                    if (element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.JOIN)) ||
                            element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.FULL)) ||
                            element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.INNER)) ||
                            element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.LEFT)) ||
                            element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.RIGHT))) {
                        ...
                        Pattern joinPattern = SystemProperties.getPattern(LayerSystemProperties.Query.JOIN_REGULAR_EXPRESSION);
                        Matcher joinMatcher = joinPattern.matcher(elementValue);
                        if(joinMatcher.matches()) {
                            String joinDynamicResource = joinMatcher.group(SystemProperties.get(LayerSystemProperties.Query.JOIN_DYNAMIC_RESOURCE_INDEX));
                            String joinResourceValue = joinMatcher.group(SystemProperties.get(LayerSystemProperties.Query.JOIN_RESOURCE_VALUE_INDEX));
                            String joinDynamicResourceAlias = joinMatcher.group(SystemProperties.get(LayerSystemProperties.Query.JOIN_DYNAMIC_RESOURCE_ALIAS_INDEX));
                            joinResource = createResource(joinResourceValue, joinDynamicResource, joinDynamicResourceAlias, groups, richTexts, placesIndex);
                            joinConditionalBody = joinMatcher.group(SystemProperties.get(LayerSystemProperties.Query.JOIN_CONDITIONAL_BODY_INDEX));
                        ...
                        query.addJoin(join);
                    } else if (element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.WHERE))) {
                        completeEvaluatorCollection(query, elementValue, groups, richTexts, query, 0, placesIndex);
                    } else if (element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.ORDER_BY))) {
                        for (String orderField : elementValue.split(SystemProperties.get(
                                LayerSystemProperties.Query.ReservedWord.ARGUMENT_SEPARATOR))) {
                    ...
                    } else if (element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.GROUP_BY)) ||
                            element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.DISJOINT_BY))) {
                        for (String orderField : elementValue.split(SystemProperties.get(
                                LayerSystemProperties.Query.ReservedWord.ARGUMENT_SEPARATOR))) {
                        ...
                        if(element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.DISJOINT_BY))) {
                            query.setDisjoint(true);
                        }
                    } else if (element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.LIMIT))) {
                    ...
                    } else if (element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.START))) {
                        if(elementValue.isBlank()) {
                    ...
                    } else if (element.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.UNDERLYING))) {
                        ...
                        Pattern sourcePatter = SystemProperties.getPattern(LayerSystemProperties.Query.SOURCE_REGULAR_EXPRESSION, Pattern.CASE_INSENSITIVE);
            ...
            for (int i = 2; i < unions.length; i+=2) {
                ...
                if (!unionString.toLowerCase().contains(SystemProperties.get(LayerSystemProperties.Query.ENVIRONMENT_GROUP_INDEX)) && environmentBody != null){
                    unionString = matcher.group(SystemProperties.get(LayerSystemProperties.Query.ENVIRONMENT_GROUP_INDEX)).concat(Strings.WHITE_SPACE).concat(unionString);
                }
    ...
    private QueryResource createResource(String resourceValue, String dynamicResource, String dynamicResourceAlias, List<String> groups, List<String> richTexts, AtomicInteger placesIndex) {
        ...
        if(dynamicResource.isBlank()) {
            ...
            Query subQuery;
            if (resourceValue.toUpperCase().startsWith(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.SELECT))) {
    ...
    private final void completeEvaluatorCollection(Query query, String startElement, List<String> groups, List<String> richTexts,
        ...
        Pattern wherePatter = SystemProperties.getPattern(LayerSystemProperties.Query.EVALUATOR_COLLECTION_REGULAR_EXPRESSION, Pattern.CASE_INSENSITIVE);
        ...
        for(String definition : evaluatorDefinitions) {
            ...
            if (definition.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.AND))) {
                if (collection == null) {
            ...
            } else if (definition.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.OR))) {
                if (collection == null) {
    ...
    private void processDefinition(Query query, String definition, EvaluatorCollection collection, List<String> groups, List<String> richTexts, AtomicInteger placesIndex) {
        ...
        evaluatorValues = definition.split(SystemProperties.get(LayerSystemProperties.Query.OPERATION_REGULAR_EXPRESSION));
        if (evaluatorValues.length == 1 && definition.startsWith(Strings.REPLACEABLE_GROUP)) {
            ...
            for (String evaluatorValue : evaluatorValues) {
                ...
                if (evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.NOT))) {
                    operator += evaluatorValue + Strings.WHITE_SPACE;
                } else if (evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.NOT_2))) {
                    operator += evaluatorValue;
                } else if (evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.DISTINCT))
                        || evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.DISTINCT_2))
                        || evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.EQUALS))
                        || evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.GREATER_THAN))
                        || evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.GREATER_THAN_OR_EQUALS))
                        || evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.IN))
                        || evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.LIKE))
                        || evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.SMALLER_THAN))
                        || evaluatorValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.SMALLER_THAN_OR_EQUALS))) {
                    operator += evaluatorValue;
                    operatorDone = true;
            ...
            if (operator == null || operator.trim().isEmpty()) {
                ...
                if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.DISTINCT)) ||
                        operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.DISTINCT_2))) {
                    evaluator = new Distinct(leftValue, rightValue);
                } else if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.EQUALS))) {
                    evaluator = new Equals(leftValue, rightValue);
                } else if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.GREATER_THAN))) {
                    evaluator = new GreaterThan(leftValue, rightValue);
                } else if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.GREATER_THAN_OR_EQUALS))) {
                    evaluator = new GreaterThanOrEqual(leftValue, rightValue);
                } else if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.IN))) {
                    evaluator = new In(leftValue, rightValue);
                } else if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.LIKE))) {
                    evaluator = new Like(leftValue, rightValue);
                } else if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.NOT_IN))) {
                    evaluator = new NotIn(leftValue, rightValue);
                } else if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.SMALLER_THAN))) {
                    evaluator = new SmallerThan(leftValue, rightValue);
                } else if (operator.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.SMALLER_THAN_OR_EQUALS))) {
    ...
    private Object processStringValue(Query query, List<String> groups, List<String> richTexts, String stringValue, AtomicInteger placesIndex, Class parameterClass, List<QueryField> presentFields) {
        ...
        String alias = null;
        String[] trimmedStringValueParts = trimmedStringValue.split(SystemProperties.get(LayerSystemProperties.Query.AS_REGULAR_EXPRESSION));
        ...
        if(trimmedStringValue.equals(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.REPLACEABLE_VALUE))) {
        ...
        } else if(trimmedStringValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.NULL))) {
            result = null;
            literal = true;
        } else if(trimmedStringValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.TRUE))) {
            result = true;
            literal = true;
        } else if(trimmedStringValue.equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.FALSE))) {
            result = false;
            literal = true;
        } else if(trimmedStringValue.startsWith(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.STRING_DELIMITER))) {
            if (trimmedStringValue.endsWith(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.STRING_DELIMITER))) {
                ...
                try {
                    result = SystemProperties.getDateFormat(LayerSystemProperties.Query.DATE_FORMAT).parse(trimmedStringValue);
                } catch (Exception ex) {
            ...
            if(group.toUpperCase().startsWith(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.SELECT)) ||
                    group.toUpperCase().startsWith(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.ENVIRONMENT))) {
                ...
                if (query.getEnvironment() != null && !group.toUpperCase().contains(LayerSystemProperties.Query.ReservedWord.ENVIRONMENT)){
            ...
            } else if(group.toUpperCase().contains(Strings.wrap(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.AND), Strings.WHITE_SPACE))
                    || group.toUpperCase().contains(Strings.wrap(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.OR), Strings.WHITE_SPACE))) {
                ...
                for (String subStringValue : group.split(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.ARGUMENT_SEPARATOR))) {
            ...
            try {
                result = SystemProperties.getDecimalFormat(LayerSystemProperties.Query.DECIMAL_FORMAT).parse(trimmedStringValue);
            ...
            try {
                result = SystemProperties.getDecimalFormat(LayerSystemProperties.Query.SCIENTIFIC_NOTATION_FORMAT).parse(trimmedStringValue);
            } catch (ParseException e) {
                result = trimmedStringValue;
            }
            literal = true;
            ...
            for (int i = 0; i < mathExpressionParts.length; i++) {
                ...
                if (i == mathExpressionParts.length - 1) {
                    ...
                    if (parameterClass.equals(QueryReturnParameter.class)) {
                        ...
                        String[] parts = currentValue.split(SystemProperties.get(LayerSystemProperties.Query.AS_REGULAR_EXPRESSION));
                        if (parts.length == 2) {
                        ...
                        String[] parts = currentValue.split(SystemProperties.get(LayerSystemProperties.Query.DESC_REGULAR_EXPRESSION));
                        if (parts.length == 3) {
                            currentValue = parts[0].trim();
                            if (parts[2].trim().equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.DESC))) {
                                desc = true;
                            }
                        }
                    }
                ...
                if (currentValue.matches(SystemProperties.get(SystemProperties.HCJF_MATH_CONNECTOR_REGULAR_EXPRESSION))) {
                    //If the current value is a math connector (+-*/) this connector is a function parameter.
            ...
            if (parameterClass.equals(QueryParameter.class)) {
                result = new QueryFunction(query, Strings.reverseGrouping(trimmedStringValue, groups),
                        SystemProperties.get(LayerSystemProperties.Query.Function.MATH_EVAL_EXPRESSION_NAME), parameters);
                ...
                result = new QueryReturnFunction(query, Strings.reverseGrouping(trimmedStringValue, groups),
                        SystemProperties.get(LayerSystemProperties.Query.Function.MATH_EVAL_EXPRESSION_NAME), parameters, alias);
            } else if (parameterClass.equals(QueryOrderParameter.class)) {
                result = new QueryOrderFunction(query, Strings.reverseGrouping(trimmedStringValue, groups),
                        SystemProperties.get(LayerSystemProperties.Query.Function.MATH_EVAL_EXPRESSION_NAME), parameters, desc);
            }
        } else {
            ...
            if(trimmedStringValue.contains(Strings.REPLACEABLE_GROUP)) {
                ...
                if(functionName == null || functionName.isBlank()) {
                    ...
                    for (String param : group.split(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.ARGUMENT_SEPARATOR))) {
                        if (!param.isBlank()) {
            ...
            if(parameterClass.equals(QueryParameter.class)) {
                ...
                boolean desc = false;
                String[] parts = originalValue.split(SystemProperties.get(LayerSystemProperties.Query.DESC_REGULAR_EXPRESSION));
                if(parts.length == 2) {
                    originalValue = parts[0].trim();
                    if(parts[1].trim().equalsIgnoreCase(SystemProperties.get(LayerSystemProperties.Query.ReservedWord.DESC))) {
                        desc = true;
                    }
                }
