...
public abstract class FieldEvaluator extends BaseEvaluator {
    ...
    private final Map<Evaluator,Object> getLeftCache() {
        return ServiceSession.getCurrentIdentity().get(SystemProperties.get(LayerSystemProperties.Query.EVALUATOR_LEFT_VALUES_CACHE_NAME));
    }
    ...
    private Map<Evaluator,Object> getRightCache() {
        return ServiceSession.getCurrentIdentity().get(SystemProperties.get(LayerSystemProperties.Query.EVALUATOR_RIGHT_VALUES_CACHE_NAME));
    }
