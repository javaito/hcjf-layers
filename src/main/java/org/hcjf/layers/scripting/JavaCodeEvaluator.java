...
public class JavaCodeEvaluator extends Layer implements CodeEvaluator {
    ...
    public JavaCodeEvaluator() {
        ...
        Integer size = SystemProperties.getInteger(LayerSystemProperties.CodeEvaluator.Java.J_SHELL_POOL_SIZE);
    ...
    public ExecutionResult evaluate(String script, Map<String, Object> parameters) {
        ...
        Long timeout = SystemProperties.getLong(LayerSystemProperties.CodeEvaluator.Java.J_SHELL_INSTANCE_TIMEOUT);
        try {
    ...
    private static class JShellInstance implements LruMap.RemoveOverflowListener {
        ...
        public void init() {
            ...
            List<String> customImports = SystemProperties.getList(LayerSystemProperties.CodeEvaluator.Java.IMPORTS);
            for (String i : customImports) {
                jShell.eval(String.format(IMPORT_TEMPLATE, i));
            }

            scriptCache = new LruMap<>(SystemProperties.getInteger(LayerSystemProperties.CodeEvaluator.Java.SCRIPT_CACHE_SIZE));
        }
